...
if __name__ == '__main__':
  ...
  im1_pl = tf.placeholder(tf.float32, [1, 376, 1241, 3])
  im2_pl = tf.placeholder(tf.float32, [1, 376, 1241, 3])
  ...
  im1 = imread('FlowNet2_src/example/000000.png')/255.
  im2 = imread('FlowNet2_src/example/000001.png')/255.
